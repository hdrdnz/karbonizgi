...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.PersonInf"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Message kısmını kullanıcıya gösterebilirsin.Eğer kullanıcı karbonayak izi dışında sorular sorarsa chat cevap vermez karbon ayak izine yönlendirir.2 kere gereksiz soru sorulursa data kısmında 'false' döner ve burada chat konuşmasını bitir sonra message kısmını kullanıcıya gösterebilirsin.",
                        "schema": {
                            "$ref": "#/definitions/controllers.Response"
                        }
                    },
        ...
        "/register": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "user_type kısmına kullanıcı kişi ise 'person' şirket ise 'company' girmelisin. Kullanıcı bireysel ise company_name girmene gerek yok.",
                        "name": "UserRegister",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.ScoreInfo"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "controllers.ScoreInfo": {
            "type": "object",
            "properties": {
                "question_key": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/controllers.QuestionSub"
                    }
                },
                "question_name": {
                    "type": "string"
